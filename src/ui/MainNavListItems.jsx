...
function NavListItems() {
  ...
  return (
    <div
      ...
      className={`${isSmallScreen && isMobileMenuOpen ? 'text-colorGrey900' : 'text-colorGrey0'} w-full border-colorBlue100 text-right md:flex md:justify-between`}
    >
      {/* Mobile Menu Icon */}
      <button
      ...
      <ul
        ...
        className={`${
          isSmallScreen && isMobileMenuOpen
            ? 'border-colorBrand absolute left-0 top-0 h-screen w-2/3 space-y-5 border-y-2 bg-colorGrey50 p-5 text-left opacity-95'
            : 'hidden'
        }  md:flex md:gap-7 `}
      >
